...
export default function EditCourierAgreement() {
    ...
    const courier = CourierData.find(r => r.courierNumber === Number(courierId));
    ...
    <SimplePageContent>
                {
                    userRole === ROLES.ADMINISTRATOR && (
                        <>
                            ...
                            <div style={{padding: '10px'}}>
                                <b>Kurjerio įdarbinimo data: </b>{courier.courierWorkStart.toLocaleString(navigator.language, {year: 'numeric', month:'numeric', day: 'numeric'})}
                            </div>
                            <div style={{padding: '10px'}}>
